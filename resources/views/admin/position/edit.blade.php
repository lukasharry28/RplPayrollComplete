        ...
        <div class="widget overflow-visible">
            ...
            <div class="widget-body">
                ...
                <form action="{{ $form_update }}" method="POST" id="editPosition">
                    ...
                    <div class="form-group">
                        <label for="title">Slug</label><small class="text-danger">*</small>
                        <input type="text" name="title" class="form-control" id="slug" placeholder="ex: sales - executive" autocomplete="off" value="{{ $position->slug }}">
                        <small class="text-danger err" id="title-err"></small>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
