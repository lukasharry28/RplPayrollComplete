<div class="nav-container">
    <nav id="main-menu-navigation" class="navigation-main">
        <div class="nav-item {{ request()->routeIs(['admin.dashboard']) ? 'active' : '' }}">
            <a href="{{ route('admin.dashboard') }}"><i class="ik ik-bar-chart-2"></i><span>Company</span></a>
        </div>
        ...
        <div class="nav-item has-sub {{ request()->routeIs('admin.payroll.*') ? 'active open' : '' }}">
            ...
            <div class="submenu-content">
                <a href="#" class="menu-item {{ request()->routeIs('admin.attendance.create') ? 'active' : '' }}"><i class="ik ik-plus-circle"></i>Set Schedule Payroll</a>
                <a href="#" class="menu-item {{ request()->routeIs('admin.attendance.create') ? 'active' : '' }}"><i class="ik ik-plus-circle"></i>Set Instant Payroll</a>
                <a href="{{ route('admin.payroll.index') }}" class="menu-item {{ request()->routeIs('admin.payroll.index') ? 'active' : '' }}"><i class="ik file-text ik-file-text"></i>History</a>
            </div>
        </div>
