...
<html class="no-js" lang="en">
    <head>
        ...
        <title>@yield('title') | MiawPayroll - A System for HR Payment Generator.</title>
                ...
                <div class="app-sidebar colored">
                    <div class="sidebar-header">
                        <a class="header-brand" href="{{ url('/') }}">
                            ...
                            <small class="text pl-2"><b>Miaw</b> Pay</small>
                        </a>
                ...
                <div class="container-fluid">
                    <div class="d-flex justify-content-between">
                        <div class="top-menu d-flex align-items-center">
                            ...
                            <button type="button" class="nav-toggle nav-link"><i data-toggle="expanded" class="ik ik-toggle-right toggle-icon"></i></button>
                            {{-- <button type="button" id="navbar-fullscreen" class="nav-link">
                                <a href="/notification" class="notif">
            ...
            <div class="page-wrap">
                ...
                <footer class="footer">
                    <div class="w-100 clearfix">
                        <span class="text-center text-sm-left d-md-inline-block">copyright@2024 - MiawPay.</span>
